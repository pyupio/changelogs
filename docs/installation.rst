...
The sources for changelogs can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/pyupio/changelogs
.. _tarball: https://github.com/pyupio/changelogs/tarball/master
